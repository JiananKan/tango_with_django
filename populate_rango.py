...
def populate():
    python_pages = [
                    ...
                    "url":"http://www.greenteapress.com/thinkpython/","views":98},
                    {"title":"Learn Python in 10 Minutes",
                    "url":"http://www.korokithakis.net/tutorials/python/","views":78} ]

    django_pages = [
                    {"title":"Official Django Tutorial",
                    "url":"https://docs.djangoproject.com/en/1.9/intro/tutorial01/","views":108},
                    {"title":"Django Rocks",
    ...
    other_pages = [
                   {"title":"Bottle",
                   "url":"http://bottlepy.org/docs/dev/","views":118},
                   {"title":"Flask",
